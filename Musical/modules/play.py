...
from Musical.config import UPDATES_CHANNEL as updateschannel
from Musical.config import que
from Musical.function.admins import admins as a
from Musical.helpers.admins import get_administrators
from Musical.helpers.channelmusic import get_chat_id
from Musical.helpers.errors import DurationLimitError
from Musical.helpers.decorators import errors
from Musical.helpers.decorators import authorized_users_only
from Musical.helpers.filters import command
from Musical.helpers.filters import other_filters
from Musical.helpers.gets import get_file_name
from Musical.services.callsmusic import callsmusic
from Musical.services.callsmusic import client as USER
from Musical.services.converter.converter import convert
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text((205, 590), f"Duration: {duration}", (0, 255, 0), font=font)
    draw.text((205, 630), f"Views: {views}", (0, 0, 0), font=font)
    draw.text(
        (205, 670),
